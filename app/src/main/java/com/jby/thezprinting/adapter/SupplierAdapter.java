...
public class SupplierAdapter extends BaseAdapter {
    ...
    private ArrayList<SupplierObject> customerObjectArrayList;
    /*
     ** for delete purpose
     */
    ...
    * */
    ...
    public SupplierAdapter(Context context, ArrayList<SupplierObject> customerObjectArrayList, boolean isNormalList, SupplierAdapterCallBack customerAdapterCallBack) {
        ...
        * */
        ...
        viewHolder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                customerAdapterCallBack.editSupplier(object);
            }
        });
        return view;
    }
    ...
    public interface SupplierAdapterCallBack{
        void editSupplier(SupplierObject object);
    }
